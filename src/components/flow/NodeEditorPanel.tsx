...
import { X, Trash2, Sparkles, Globe, Timer, ShieldAlert, UserCheck, GitBranch } from 'lucide-react';
...
export function NodeEditorPanel() {
  const { nodes, selectedNodeId, isPanelOpen, setPanelOpen, updateNodeData, deleteNode } = useFlowStore();
    ...
    <div className={cn(
      ...
      <div className="flex items-center justify-between p-4 border-b border-border">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h2 className="font-semibold text-foreground">{nodeTypeLabels[selectedNode.type || 'start']}</h2>
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) => updateField('conditions', {
                  ...formData.conditions,
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(value) => updateField('conditions', {
                  ...formData.conditions,
                  operator: value,
                })}
              >
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(value) => updateField('apiConfig', {
                  ...formData.apiConfig,
                  method: value,
                })}
              >
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) => updateField('apiConfig', {
                  ...formData.apiConfig,
                  url: e.target.value,
                })}
            ...
            <div className="grid grid-cols-2 gap-2">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => updateField('delayConfig', {
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) => updateField('delayConfig', {
                    ...formData.delayConfig,
                    unit: value,
                  })}
                >
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <Textarea
                ...
                onChange={(e) => updateField('fallbackConfig', {
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) => updateField('handoffConfig', {
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(value) => updateField('handoffConfig', {
                  ...formData.handoffConfig,
